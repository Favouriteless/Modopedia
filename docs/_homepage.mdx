...
For mod developers, go to **[Environment Setup](./mod_developers/environment-setup)**
...
| Type    | Description                                                                                                               |
|---------|---------------------------------------------------------------------------------------------------------------------------|
| FString | Formattable String, this is a string which supports Modopedia's **[Text Formatting](./docs/books/text-formatting)** tags. |
...
After installing the mod, head over [here](./docs/books/overview) to start working on your first book.
...
public interface  BookScreenFactory<T extends BookType> {
     ...
     */
    @Nullable BookScreen openLandingScreen(T type, Book book, String language, LocalisedBookContent content, BookScreen lastScreen);

    /**
     * @return A "entry" screen for a given entry location. Traditionally this shows a list of entries in the
     * entry.
     */
    @Nullable BookScreen openCategoryScreen(T type, Book book, String language, LocalisedBookContent content, String category, BookScreen lastScreen);
     ...
     */
    @Nullable BookScreen openEntryScreen(T type, Book book, String language, LocalisedBookContent content, String entry, BookScreen lastScreen);

 ...
 */
public record BookTexture(ResourceLocation location, int width, int height, int texWidth, int texHeight, List<PageDetails> pages,
                          WidgetDetails left, WidgetDetails right, WidgetDetails back, WidgetDetails refresh) {
    ...
    public record PageDetails(int x, int y, int width, int height) {
        ...
        ).apply(instance, PageDetails::new));

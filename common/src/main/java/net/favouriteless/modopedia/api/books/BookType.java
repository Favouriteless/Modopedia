...
public interface BookType {
     ...
     */
    @Nullable Screen openLandingScreen(Book book, LocalisedBookContent content);

    /**
     * @return A "category" screen for a given category location. Traditionally this shows a list of entries in the
     * category.
     */
    @Nullable Screen openCategoryScreen(Book book, LocalisedBookContent content, String category);
     ...
     */
    @Nullable Screen openEntryScreen(Book book, LocalisedBookContent content, String entry);

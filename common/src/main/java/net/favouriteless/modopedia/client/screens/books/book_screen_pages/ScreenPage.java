...
public abstract class ScreenPage {
     ...
     * @param dimensions {@link Dimensions} object for where this page is placed on it's texture
     * @param mouseX X position of the mouse relative to this page
     * @param mouseY Y position of the mouse relative to this page
     * @param partialTick
     */
    public abstract void render(GuiGraphics graphics, PoseStack poseStack, Dimensions dimensions, int mouseX, int mouseY, float partialTick);

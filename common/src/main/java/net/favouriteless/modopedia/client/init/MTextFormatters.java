...
public class MTextFormatters {
    ...
    public static void load() {
        ...
        registry.register(new SimpleFormatter((stack, tag) -> stack.modify(s -> s.withClickEvent(null)), "/cmd", "/clip"));
        ...
        registry.register(new SimpleFormatter((stack, tag) -> stack.modify(style -> style.withClickEvent(null).withHoverEvent(null)), "/l", "/cl", "/el"));

        // These formatters needed special handling.
        registry.register(new ExternalLinkFormatter());

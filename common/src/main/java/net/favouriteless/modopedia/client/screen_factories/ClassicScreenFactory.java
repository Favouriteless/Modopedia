...
public class ClassicScreenFactory implements BookScreenFactory<ClassicBookType> {
    ...
    @Override
    public @Nullable BookScreen openLandingScreen(ClassicBookType type, Book book, String langCode, LocalisedBookContent content, BookScreen lastScreen) {
        return new ClassicLandingScreen(book, langCode, content);
    }

    @Override
    public @Nullable BookScreen openCategoryScreen(ClassicBookType type, Book book, String langCode, LocalisedBookContent content, String category, BookScreen lastScreen) {
    ...
    @Override
    public @Nullable BookScreen openEntryScreen(ClassicBookType type, Book book, String langCode, LocalisedBookContent content, String entry, BookScreen lastScreen) {

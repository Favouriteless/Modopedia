...
public class TextFormatterRegistry {
    ...
    static {
        ...
        register(new SimpleFormatter((stack, tag) -> stack.modify(s -> s.withHoverEvent(null)), "/t", "/hi"));
        ...
        register(new SimpleFormatter((stack, tag) -> stack.modify(style -> style.withClickEvent(null).withHoverEvent(null)), "/cl", "/el"));
